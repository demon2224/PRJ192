...
public class ProductDAO extends DBContext {
    ...
    public int insert(Product product) {
        ...
        try {
            ...
            ps.setLong(3, product.getpPrice());
            ps.setInt(4, product.getpQuan());
            ps.setString(5, product.getpDes());
    ...
    public int update(Product product) {
        ...
        try {
            ...
            ps.setLong(2, product.getpPrice());
            ps.setInt(3, product.getpQuan());
            ps.setString(4, product.getpDes());
            ps.setString(5, product.getCat().getCatId());
            ps.setString(6, product.getpId());
