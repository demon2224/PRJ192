        ...
        <div class="container movies">
            ...
            <form method="POST" action="Product?action=update">
                ...
                <div class="mb-3"> 
                    ...
                    <input id="pName" type="text" name="pName" class="form-control" required value="<%= products.getProNameString()%>">
                </div>
                <div class="mb-3"> 
                    <label class="form-label">Product Price</label>
                    <input id="pPrice" type="number" name="pPrice" min="0" step="any" class="form-control" required value="<%= products.getProPrice()%>">
                </div>
                <div class="mb-3"> 
                    <label class="form-label">Product Quantity</label>
                    <input id="pQuantity" type="number" name="pQuantity" min="0" class="form-control" required value="<%= products.getProQuantity()%>">
                </div>
                <div class="mb-3"> 
                    <label class="form-label">Product Description</label>
                    <input id="pDescription" type="text"  name="pDescription" class="form-control" required value="<%= products.getProDescription()%>">
                </div>
                <div class="mb-3"> 
