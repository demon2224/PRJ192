 ...
 * @author Admin
 */
@WebServlet(name = "MovieServlet", urlPatterns = {"/list"})
public class JobServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        JobDAO productDAO = new JobDAO();
        
        if (action.equalsIgnoreCase("list")) {
            List<Job> products = productDAO.getAll();
...
//                Job product = productDAO.getAccountById(id);
//                List<Category> categorys = categoryDAO.getAll();
...
//                if (productDAO.insert(new Job(proQuantity, proName, proPrice, proQuantity, proDescription, new Category(catID))) == 1) {
...
//                    request.setAttribute("err", errorMessage);
//                    request.getRequestDispatcher("Job?action=delete&id=" + id).forward(request, response);
//                }
//            } catch (Exception e) {
//                PrintWriter out = response.getWriter();
//                out.print(e.getMessage());
...
//                int proQuantity = Integer.parseInt(proQuantityRaw);
//                int catID = Integer.parseInt(catIdRaw);
//                if (productDAO.update(new Job(id, proName, proPrice, proQuantity, proDescription, new Category(catID))) == 1) {
//                    response.sendRedirect("Job");
//                } else {
